		 ...
		 <div class="errorMessage" align="center"><?php echo $errorMessage; ?></div>
		  ...
		  <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
           ...
           <tr class="entryTable">
             ...
             <td class="content"><input name="txtfacid" type="text" class="box" id="txtMob" value="" size="30" maxlength="20" /></td>
           </tr>
           <tr class="entryTable">
             <td class="label">&nbsp;Section. </td>
             <td class="content"><input name="txtsec" type="text" class="box" id="txtMob" value="" size="30" maxlength="20" /></td>
           </tr>
           <tr class="entryTable">
